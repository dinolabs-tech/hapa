    ...
    <aside id="leftsidebar" class="sidebar">
        ...
        <div class="menu">
            <ul class="list">
                ...
                <li class="open"><a href="#manage_alumni_testimonials"><i class="zmdi zmdi-star"></i><span>Manage Alumni Testimonials</span></a></li>
            ...
            <div class="container-fluid">
                ...
                <div class="row clearfix">
                    <div class="col-lg-12">
                        <div class="body">
                            <div class="ms-4">
                                <h6><strong>Student</strong> Management</h6>
                            </div>
                            <div class="row">
                                <!-- ENROLLMENT -->
                            ...
                            <div class="mt-3 ms-4">
                                <h6><strong>Attendance</strong> Management</h6>
                            </div>
                            <div class="row">
                                <div class="col-lg-12">
                            ...
                            <div class="mt-3 ms-4">
                                <h6><strong>Results</strong> Management</h6>
                            </div>
                            ...
                            <div class="mt-3 ms-4">
                                <h6><strong>E-Learning</strong> Resources</h6>
                            </div>
                            ...
                            <div class="mt-3 ms-4">
                                <h6><strong>CBT (Computer Based Test)</strong> Management</h6>
                            </div>
                            ...
                            <div class="mt-3 ms-4">
                                <h6><strong>Tuckshop</strong> Management</h6>
                            </div>
                            ...
                            <div class="mt-3 ms-4">
                                <h6><strong>General</strong> Administration</h6>
                            </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="accordion" id="generalAdministrationAccordion">
                                        ...
                                        <div class="accordion" id="generalAdministrationAccordion">
                                            ...
                                            <div class="accordion-item">
                                                <h2 class="accordion-header" id="headingManageAlumniTestimonials">
                                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseManageAlumniTestimonials" aria-expanded="false" aria-controls="collapseManageAlumniTestimonials">
                                                        How to Manage Alumni Testimonials
                                                    </button>
                                                </h2>
                                                <div id="collapseManageAlumniTestimonials" class="accordion-collapse collapse" aria-labelledby="headingManageAlumniTestimonials" data-bs-parent="#generalAdministrationAccordion">
                                                    <div class="accordion-body">
                                                        <div id="manage_alumni_testimonials">
                                                            <p>The "Manage Alumni Testimonials" feature provides a robust system for collecting, storing, and displaying testimonials for former students. This is an invaluable tool for showcasing student success, building institutional reputation, and inspiring current and prospective students. It allows administrators to add new testimonials, view existing ones, and manage their status.</p>
                                                            <ol>
                                                                <li><strong>Navigate to the Alumni List Page:</strong>
                                                                    <ul>
                                                                        <li>From the sidebar menu, go to <strong>Administrator > Alumni List</strong>.</li>
                                                                ...
                                                                <li><strong>Add a New Testimonial:</strong>
                                                                    <ul>
                                                                        <li>On the Alumni List page, locate the desired alumnus from the list.</li>
                                                                        <li>Next to each alumnus, you will find an "Add Testimonial" button. Click this button to open a modal form.</li>
                                                                        <li>Fill in the testimonial details in the form, including:
                                                                            <ul>
                                                                                <li><strong>Subjects Offered:</strong> (comma-separated list of subjects the alumnus offered).</li>
                                                                                <li><strong>Academic Ability:</strong> Assessment of the alumnus's academic strengths.</li>
                                                                                <li><strong>Prizes Won:</strong> Any awards or recognitions received by the alumnus.</li>
                                                                                <li><strong>Character Assessment:</strong> Remarks on the alumnus's character and conduct.</li>
                                                                                <li><strong>Office Held:</strong> Any leadership positions held by the alumnus.</li>
                                                                                <li><strong>Co-curricular Activities:</strong> Participation in extracurriculars.</li>
                                                                                <li><strong>General Remarks:</strong> Overall comments and recommendations.</li>
                                                                            </ul>
                                                                        </li>
                                                                        <li>Click "Save Testimonial" to submit the new testimonial.</li>
                                                                        <li><strong>Important for Users:</strong> Ensure all fields are filled accurately to provide a comprehensive testimonial.</li>
                                                                    </ul>
                                                                </li>
                                                                <li><strong>View Existing Testimonials:</strong>
                                                                    <ul>
                                                                        <li>For alumni who already have a testimonial, a "View Testimonial" icon (<i class="fas fa-eye"></i>) will appear next to their entry on the Alumni List page.</li>
                                                                        <li>Click this icon to be redirected to view the full details of the testimonial.</li>
                                                                        <li><strong>Benefit for Users:</strong> This provides quick access to detailed testimonials for review or verification.</li>
                                                                    </ul>
                                                                </li>
                                                                <li><strong>Benefits of this Feature:</strong>
                                                                    <ul>
                                                                        <li><strong>Showcase Success:</strong> Highlights the achievements and positive experiences of former students.</li>
                                                                        <li><strong>Enhanced Reputation:</strong> Builds trust and credibility for the institution.</li>
                                                                        <li><strong>Inspiration:</strong> Motivates current students by demonstrating paths to success.</li>
                                                                        <li><strong>Marketing Tool:</strong> Provides compelling content for promotional materials.</li>
                                                                        <li><strong>Comprehensive Records:</strong> Ensures that valuable alumni feedback is well-organized and easily accessible.</li>
                                                                    </ul>
                                                                </li>
                                                            </ol>
                                                        </div>
                            ...
                            <!-- License Management -->
                            <div class="mt-3 ms-4">
                                <h6><strong>License</strong> Management</h6>
                            </div>
