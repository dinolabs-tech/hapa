...
$message = '';
$target_dir = 'Curriculum/'; // Define this outside to use globally
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['upload'])) {
    ...
    if (isset($_FILES['document']) && $_FILES['document']['error'] == 0) {
        ...
        if (move_uploaded_file($document['tmp_name'], $target_file)) {
            ...
            $insert_sql = "INSERT INTO curriculum (subject_name, class_name, file_name)
      ...
      <div class="main-panel">
        ...
        <div class="container">
          <div class="page-inner">
            ...
            >
              <div>
                <nts class="fw-bold mb-3">Curriculum</h3>
                <ol class="breadcrumb">
