    ...
    <form action="" id="manage-course">
        ...
        <div class="col-lg-6 border-right">
            ...
            <div class="form-group">
                <label for="" class="control-label">Fee Name</label>
            ...
            <div class="form-group">
                <label for="" class="control-label">Arm</label>
                <input type="text" class="form-control" name="arm"  value="<?php echo isset($arm) ? $arm :'' ?>" required>
            </div>
            <div class="form-group">
                <label for="" class="control-label">Hostel</label>
                <input type="text" class="form-control" name="hostel"  value="<?php echo isset($hostel) ? $hostel :'' ?>" required>
            </div>
            <div class="form-group">
