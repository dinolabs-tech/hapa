...
$header = ['ID', 'NAME', 'COMMENT','SCHL_OPEN', 'DAYS_PRESENT', 'DAYS_ABSENT', 'ATTRACTIVENESS', 'NEATNESS', 'POLITENESS', 'SELFCONTROL', 'PUNCTUALITY', 'RELATIONSHIP', 'HANDWRITING', 'MUSIC', 'CLUB', 'SPORT'];
